...
class OpenLauncher private constructor(
    ...
    fun launch(
        ...
        var command = "${findLocalJavaPath(optInLegacyJava)} $jvmArguments -classpath $classpath -Djava.library.path=$root/natives/ $mainClass ${if (isServer) "nogui" else ""} $arguments"
